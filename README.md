...
| **🟢🔴 매수/매도 권장 알림** | STRONG BUY/STRONG SELL 신호 시 권장 가격과 함께 자동 알림 (하루 최대 3회) |
...
- **한 종목당 하루 최대 3회**까지 알림이 전송됩니다 (과도한 알림 방지)
- 알림 횟수는 `.env` 파일의 `MAX_DAILY_RECOMMENDATION_ALERTS` 환경 변수로 조정 가능합니다
